function isDuplicate(input, stateObject) {
  // !! converts the output into a boolean
  return !!stateObject.entries.find((element) => element.description === input);
}
...
export function initApp() {
  ...
  document.querySelector("#add-todo").addEventListener("click", () => {
    ...
    if (isDuplicate(description, stateObject) === false) {
      const id = Date.now();
